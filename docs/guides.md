...
| [**Controllers**]({{ '/controllers/' | relative_url }}) | Synchronous business logic before/after DB operations: validation, normalization, response enrichment, generated registration, and the runtime `Context` API. Includes WASM plugin support for TypeScript, Python, and other languages. |
